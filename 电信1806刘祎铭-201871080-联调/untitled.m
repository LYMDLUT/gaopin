...
resource_named='USB0::0x1AB1::0x04B0::DS2D223401453::INSTR';
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
II1=str2num(get(handles.edit1,'String'));
II2=str2num(get(handles.edit2,'String'));
II3=str2num(get(handles.edit3,'String'));
II4=str2num(get(handles.edit4,'String'));
II5=str2num(get(handles.edit5,'String'));
II6=str2num(get(handles.edit6,'String'));
IIIl=sprintf([':SOURCE%1:APPLy:SINusoid',II1,'MHz,',II2,'mVrms,',II3,II4]);
III2=sprintf([':SOURCE%1:MOD:AM',II5]);
III3=sprintf([':SOURCE%1:MOD:AM:INTernal:FREQuency',II6,'kHz']);



writeCommand(handles.ddg,IIIl);
writeCommand(handles.ddg,sprintf(':SOURCE%1:MOD ON'));
writeCommand(handles.ddg,sprintf(':SOURCE%1:MOD:TYPe AM'));
writeCommand(handles.ddg,III2);
writeCommand(handles.ddg,III3);
writeCommand(handles.ddg,sprintf(':SOURCE%1:MOD:AM:INTernal:FUNCtion SINusoid'));
